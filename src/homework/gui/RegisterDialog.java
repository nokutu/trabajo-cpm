...
public class RegisterDialog extends JDialog {
  ...
  public RegisterDialog() {
    ...
    panel.add(password2, "growx, wrap");
    ...
    panel.add(tlfNumber, "growx, wrap");
